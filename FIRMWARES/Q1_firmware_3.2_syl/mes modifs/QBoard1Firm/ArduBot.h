...
#include "comands.h"
#include "motores.h"
#include "LCD03.h" // pour gestion du LCD
//-------------------------------------------------------------//
...
// FLOOR SENSOR HIGH AND LOW VALUES IN CM. Normal=24cm
#define MIN_FLOOR_DISTANCE_CM 16
#define MAX_FLOOR_DISTANCE_CM 28
...
//-------------------------------------------------------------//
//----------Definitions pour la communication avec les SRF10---------//
...
class ArduBot
{
  ...
  public:
    ...
    //--------------Fonction de positionnement et de vitesse--------------//
    ...
    //----------------Funcion de calibration de l'IMU---------------------//
    inline void calibrate() {
      ...
      while (state != 2) { // n est pas egal a 2
        if (state == 0) {
    ...
    //----------Fonction de lecture du capteur GP2D12-----------------//
    ...
    //--------Fonction de lecture du niveau batterie-------------//
