...
int CQboduinoDriver::getIMU(int16_t& gyroX,int16_t& gyroY,int16_t& gyroZ,int16_t& accelerometerX,int16_t& accelerometerY,int16_t& accelerometerZ)
{
    std::vector<dataUnion> data,sent;
    ...
    accelerometerX=(int16_t)data[3].h;
    accelerometerY=(int16_t)data[4].h;
    accelerometerZ=(int16_t)data[5].h;
