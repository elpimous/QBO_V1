...
static double gyro_measurement_scale = 250.0*3.1416/(180.0*32768.0);//sensitivity can be 0.07 or 0.0175 or 0.00875 and conversion degrees to radians(250*pi/(180*32768))

//accelerometer is in +- 2g mode, so sensibility is 18 mg/digit.
static double acc_measurement_scale = 9.81/16384.0;//2*9.81/32768
