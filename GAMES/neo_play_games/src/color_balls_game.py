...
class Game():
    ...
    def exiting(self):
        ...
        self.run_process("rosnode kill /alfred_balls_color_publisher")
        self.run_process("rosnode kill /alfred_listen")
        sleep(0.2)
        self.run_process("rosnode kill /color_balls_game")
        self.speak_this("Je quitte,")

if __name__ == '__main__':
    #try:
        rospy.init_node("alfred_play_color_balls")
        a = Game()
        b = a.start()
